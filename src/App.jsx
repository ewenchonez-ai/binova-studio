...
// Cellule de date modifiable : affiche "Lun 08 jui" mais un date picker natif
// s'ouvre au clic (input transparent superposé).
function DateCell({ value, onChange }) {
  return (
    ...
    >
      <span className="mono" style={{ fontSize:12, pointerEvents:'none', display:'block' }}>
        {formatDate(value)}
      </span>
      <input
        type="date"
